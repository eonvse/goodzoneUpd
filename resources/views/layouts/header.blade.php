<header>
    <nav class="fixed top-0 left-0 invisible md:visible w-full shadow-2xl bg-gradient-to-r from-white to-amber-300 z-50">
        <div class="flex max-w-screen-lg items-center mx-auto">
        <div id="logo" class="text-blue-500 p-1">
            <a href="{{ route('welcome.index') }}">
                <h1 class="text-4xl md:text-5xl invisible md:visible">Good&nbsp;Zone</h1>
            </a>
        </div>
        <div class="w-full flex-1 mx-2">
            <a class="flex items-center mx-1 text-gray-600 hover:text-blue-500 transition-all rounded" href="{{ route('welcome.photo') }}">
                ...
                <span class="mx-1 invisible md:visible">Фотогалерея</span>
            </a>
        </div>
        <div class="w-full flex-1 mx-2 text-gray-600">
            <a class="flex items-center mx-1 hover:text-amber-600 transition-all rounded" href="tel:+79148767422">
                ...
                <span class="mx-1 invisible md:visible">+79148767422</span>
            </a>
        </div>
        <div class="w-full flex-1 items-center mx-2 text-gray-600 hover:text-blue-800">
            <a class="flex items-center mx-1 transition-all rounded" href="https://vk.com/uigoodzone"><x-icon-vk /></a>
        </div> 
        <div class="w-full flex-1 items-center mx-2 text-gray-600">
            <a class="flex items-center hover:text-amber-600 transition-all rounded" href="mailto:hectkova@yandex.ru">
                <svg class="h-8 w-8 text-gray-600 hover:text-red-600 mx-auto"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="12" r="4" />  <path d="M16 12v1.5a2.5 2.5 0 0 0 5 0v-1.5a9 9 0 1 0 -5.5 8.28" /></svg>
            </a>
        </div>                        
        <div class="w-full flex-1 items-center mx-2 text-gray-600">
            г. Усть-Илимск
