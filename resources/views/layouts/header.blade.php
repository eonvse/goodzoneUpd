                ...
                <!-- <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8"> -->
                     <nav class="fixed top-0 left-0 flex invisible md:visible w-full items-center justify-left shadow-2xl bg-gradient-to-r from-white to-yellow-300">
                        ...
                        <div class="w-full flex-1 mx-2 text-gray-600">
                            <a class="flex items-center mx-1 hover:text-yellow-600 transition-all rounded" href="tel:+79148767422">
                        ...
                        <div class="w-full flex-1 items-center mx-2 text-gray-600">
                                <a class="flex items-center hover:text-yellow-600 transition-all rounded" href="mailto:hectkova@yandex.ru">
                    ...
                    <nav class="fixed bottom-0 flex w-full items-center justify-left shadow-2xl visible md:invisible bg-gradient-to-r from-white to-yellow-300 py-1 text-gray-600">
                        <div class="flex-1 text-center">
                            <a class="transition-all rounded h-10 w-10" href="https://vk.com/uigoodzone"><x-icon-vk /></a>
                        </div> 
                        <div class="flex-1 text-center">
                                <a class="hover:text-yellow-600 transition-all rounded" href="mailto:hectkova@yandex.ru">
                        ...
                        <div class="flex-1 text-center">
                            <a class="hover:text-yellow-600 transition-all rounded" href="tel:+79148767422">
