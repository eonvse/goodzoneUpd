<x-app-layout>
    <x-slot name="header">
        ...
        <x-head.h2>
            ФОТОГАЛЕРЕЯ
            <x-button.create href="{{ route('images.create') }}">Добавить</x-button.create>
        </x-head.h2>
    </x-slot>
                    ...
                    <table class="w-full table-fixed border-collapse border border-solid border-gray-200 align-top">
                      <thead class="p-1 w-wull bg-white">
                        <tr class="flex text-gray-500">
                          ...
                          <th class="flex-1 min-w-2/5"><span class="font-bold">Заголовок</span>| <span class="font-extralight">Дата</span></th>
                        </tr>
                      </thead>
                      <tbody>
